...
namespace Forms9Patch
{
	...
	public class Grid : Xamarin.Forms.Grid, IRoundedBox, IBackgroundImage
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Forms9Patch.Grid"/> class.
		/// </summary>
		public Grid ()
		{
			_id = _count++;
		...
		/// <summary>
		/// Returns a <see cref="System.String"/> that represents the current <see cref="Forms9Patch.Grid"/>.
		/// </summary>
		/// <returns>A <see cref="System.String"/> that represents the current <see cref="Forms9Patch.Grid"/>.</returns>
		...
		/// </summary>
		public static BindableProperty BackgroundImageProperty = BindableProperty.Create ("BackgroundImage", typeof(Image), typeof(Grid), null);
		/// <summary>
		...
		/// <summary>
		/// Gets or sets a flag indicating if the Grid's shadow is inverted. This is a bindable property.
		/// </summary>

...
namespace Forms9Patch
{
    ...
    public class StackLayout : Xamarin.Forms.StackLayout, ILayout
    {
        ...
        /// </summary>
        public static readonly BindableProperty IgnoreChildrenProperty = BindableProperty.Create("IgnoreChildren", typeof(bool), typeof(StackLayout), default(bool));
        /// <summary>
        ...
        #region Constructor
        /// <summary>
        /// Initializes an instance of the <see cref="Forms9Patch.StackLayout"/> class.
        /// </summary>
        public StackLayout()
        {
            _id = _instances++;
        ...
        #region Description
        /// <summary>
        /// Returns a <see cref="System.String"/> that describes the current <see cref="Forms9Patch.StackLayout"/>.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that describes the current <see cref="Forms9Patch.StackLayout"/>.</returns>

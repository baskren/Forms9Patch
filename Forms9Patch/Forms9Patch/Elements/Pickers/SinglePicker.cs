...
namespace Forms9Patch
{
	...
	public class SinglePicker : Frame
	{
		...
		/*
		/// <summary>
		/// The selection pad view property.
		/// </summary>
		public static readonly BindableProperty SelectionPadViewProperty = BindableProperty.Create("SelectionPadView", typeof(View), typeof(SinglePicker), null);
		/// <summary>
		/// Gets or sets the selection pad view.
		/// </summary>
		/// <value>The selection pad view.</value>
		public View SelectionPadView
		{
			get { return (View)GetValue(SelectionPadViewProperty); }
			set { SetValue(SelectionPadViewProperty, value); }
		}
		*/
		#endregion
		...
		//};
		//Xamarin.Forms.ContentView _selectionPadView = new Xamarin.Forms.ContentView();

...
#if __DROID__
            : base(Xamarin.Forms.Forms.Context)
#endif
        {
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        internal Xamarin.Forms.Size SourceImageSize()
        {
            if (_sourceBitmap?.SKBitmap != null)
                return new Xamarin.Forms.Size(_sourceBitmap.Width / FormsGestures.Display.Scale, _sourceBitmap.Height / FormsGestures.Display.Scale);

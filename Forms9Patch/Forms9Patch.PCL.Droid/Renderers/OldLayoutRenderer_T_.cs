...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            //System.Diagnostics.Debug.WriteLine("{0}[{1}] disposing=["+disposing+"]", P42.Utils.ReflectionExtensions.CallerString(), GetType());
            if (disposing)
            {
                //System.Diagnostics.Debug.WriteLine("{0}[{1}] disposing", P42.Utils.ReflectionExtensions.CallerString(), GetType());
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		~LayoutRenderer()
		{
			//System.Diagnostics.Debug.WriteLine("{0}[{1}] ", P42.Utils.ReflectionExtensions.CallerString(), GetType());
			_oldImage = null;
			_imageViewManager?.Dispose();
			_imageViewManager = null;
			try

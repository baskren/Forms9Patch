...
namespace Forms9Patch
{
    ...
    public class ListView : Xamarin.Forms.ListView
    {
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            else if (BaseItemsSource != null)
            {
                ...
                //	BaseItemsSource.HasUnevenRows = HasUnevenRows;
                    ...
                    BaseItemsSource.GroupHeaderRowHeight = GroupHeaderRowHeight;
            }
        }
        ...
        void UpdateItemsSourceAction()
        {
            ...
            _baseItemsSource.GroupHeaderRowHeight = GroupHeaderRowHeight;
        ...
        public double ScrollOffset
        {
            get
            {
                if (RendererScrollOffset == null)
                    return 0;
                return RendererScrollOffset.Invoke();
            }
        }
        ...
        public double OffsetFromBottom(object item)
        {
            ...
            if (Footer is VisualElement footer)
        ...
        void OnLongPressing(object sender, ItemWrapperLongPressEventArgs e)
        {
            ...
            if (_longPress != null && _longPress.ItemWrapper.BaseCellView != null)
            {
                ...
                bool canDrag = true;
                if (CanDrag != null)
                    canDrag = CanDrag(this, _longPress.ItemWrapper.Source, _longPress.DeepIndex);
                if (!canDrag)
                {
                    _longPress = null;
                    return;
                ...
                _baseItemsSource.DeepSwap(_longPress.ItemWrapper, _nullItem);
